...
# Subjects' labels
segments = [nb.load(f) for f in Path(base_dir).rglob("reg_cropped_best_subjects/*/*labels2template2.nii.gz")]
...
nii.to_filename(output_dir+"prob_map_cropped_th0_2.nii.gz")